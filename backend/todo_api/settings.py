...
# SECURITY: Whitelist specific allowed hosts
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # CORS middleware before common middleware
...
# Database - Use SQLite for local development and tests
DATABASES = {
    'default': {
